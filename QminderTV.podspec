...
Pod::Spec.new do |s|
  s.name             = 'QminderTV'
  s.version          = '0.1.0'
  s.summary          = 'A short description of QminderTV.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/QminderTV'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Kristaps Grinbergs' => 'kristaps@qminderapp.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/QminderTV.git', :tag => s.version.to_s }
